...
//  FDTable1.IndexDefs.Add('DT','DateTime',[ixDescending]);
//  FDTable1.IndexDefs.Add('GUID','Guid',[ixUnique]);
  //FDTable1.IndexesActive := True;
//  FDTable1.IndexName := 'DT';
